...
# Default-Stop:      0 1 6
# Short-Description: DEBIAN initscript for rtu.js servers/apps
# Description:       RMC Telemetry Unit
#                    place this file in /etc/init.d.
### END INIT INFO
 
# Author: Shane Bowyer <shane@realtelematics.co.za>
#
...
# PATH=/sbin:/usr/sbin:/bin:/usr/bin:/usr/local/bin:/home/debian/RTU
# PATH=/home/debian/RTU:/usr/*:/sbin:/bin
 
DAEMON_ARGS="/home/debian/RTU/rtu.js"       # path to your node.js server/app
                                            # NB: don't use ~/ in path
 
DESC="rtu.js http server"                   # whatever fancy description you like
