...
var sbModule = function() {
    ...
    ModbusComms.init(__settings.value.localwebserver.ipAddress,__settings.value.modbusslave.port,1);
    console.log('Listening for MODBUS on: ' + __settings.value.modbusslave.port);
